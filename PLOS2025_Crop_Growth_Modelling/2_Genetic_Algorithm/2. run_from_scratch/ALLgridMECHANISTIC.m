...
ANTdb = []; MATdb = []; ETdb = []; 
            ...
            %% launch DSSAT
                ...
                while status == 1
                    ...
                    [status,cmdout] = system('"D:\Steven02-12-2025\Desktop\CORE PHD - DEC2025\1. CODE CORE - DEC2025\CODE PhD - TEST 2025\PLOS\2_Genetic_Algorithm\2. run_from_scratch\RdssatMATLAB21-2.R"');  
