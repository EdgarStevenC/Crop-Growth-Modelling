...
labels = {'\bf Grain Yield(Kg/Ha)', '\bf Biomass(Kg/Ha)', '\bf Grain Number(#/m2)', ...
          '\bf Tiller Number(#/m2)', '\bf Leaf Area Index(m2/m2)', '\bf Root Depth(m)', ...
          '\bf Evapotranspiration(mm)', '\bf HI', '\bf WUE(Kg/mm)'};
...
f1 = gcf;
f1.Position = [75.6667  207.6667  898.0000  398.6667];
