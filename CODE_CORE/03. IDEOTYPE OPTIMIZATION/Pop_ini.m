...
G1 = [50: ((75-50)/N) :75];           % 50:    ((75-50)/N) :75             % 247.1;    % potential spikelet number    [38: ((540-38)/N) :540];
G2 = [0.015: ((0.030-0.015)/N) :0.030]; % 0.015: ((0.030-0.015)/N) :0.030    % .063;     % single grain weigt        
G3 = [0.7: ((1.3-0.7)/N) :1.3];        % 0.7:   ((1.3-0.7)/N) :1.3          % 1.20;     % Tillering coheficient - (Cual es numero maximo de tallos N4)      
