...
savefig('Results\SOIL1.fig')
exportgraphics(gcf, 'Results\SOIL1.png', 'Resolution', 300)
...
f1.Position = [232.3333  279.6667  494.6667  357.3333];
l.Position = [0.1416    0.6216    0.5064    0.1870];
savefig('Results\SOIL2.fig')
exportgraphics(gcf, 'Results\SOIL2.png', 'Resolution', 300)
...
f1.Position = [232.3333  279.6667  494.6667  357.3333];
l.Position = [0.1416    0.6216    0.5064    0.1870];
savefig('Results\SOIL3.fig')
exportgraphics(gcf, 'Results\SOIL3.png', 'Resolution', 300)
